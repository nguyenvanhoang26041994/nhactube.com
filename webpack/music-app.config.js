...
const entryMains = {
  mobile: 'src/main.mobile-only.micro-fe.js',
  desktop: 'src/main.desktop-only.micro-fe.js'
};

module.exports = require('./base.config')({
  mode: 'development',
  entry: [
    path.join(process.cwd(), entryMains[process.env.APP_MODE] || 'src/main.micro-fe.js'),
  ],
  output: {
    filename: '[name].js',
    chunkFilename: '[name].js',
    publicPath: '/music-app/',
    path: path.resolve(__dirname, '../../public/music-app/'),
  },
